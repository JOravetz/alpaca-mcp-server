...
async def analyze_peaks_troughs_fast(
    ...
    try:
        ...
        if symbols.upper() == "AUTO":
            # Get symbols from scanner - NOTE: get_scanner_results was removed
            # User should run scan_day_trading_opportunities and pass results manually
            return (
                "AUTO mode requires manual symbol input. "
