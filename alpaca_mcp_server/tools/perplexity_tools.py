...
def _fetch_quote(scraper: "cloudscraper.CloudScraper", symbol: str) -> dict:  # type: ignore[name-defined]
...
def _fetch_profile(scraper: "cloudscraper.CloudScraper", symbol: str) -> dict:  # type: ignore[name-defined]
...
async def get_perplexity_movers() -> str:
    ...
    lines = ["\n" + "=" * 60, "  🚀 TOP MOVERS - Perplexity Finance", "=" * 60, ""]
